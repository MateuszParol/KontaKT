...
from kontakt.database.models import Account, Contractor, Document, DocumentLine, ProductCatalog, SalesInvoice, SalesInvoiceItem, Settings
...
def init_db():
    ...
    # Tworzenie tabel
    database.create_tables([Account, Contractor, Document, DocumentLine, ProductCatalog, SalesInvoice, SalesInvoiceItem, Settings], safe=True)
